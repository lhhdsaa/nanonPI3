...
printf("lh gpioB12 off\r\n");
//set alternate  gpioB12
temp=ReadIO32(0xC001B020);
temp|=(0x3<<24);
WriteIO32(0xC001B020,temp);
printf("inputen register is 0x%x\r\n",temp);

//input disable
temp=ReadIO32(0xC001B010);
temp&=(~(1<<12));
WriteIO32(0xC001B010,temp);
printf("inputen register is 0x%x\r\n",temp);
...
//output enable
temp=ReadIO32(0xC001B004);
temp|=(1<<12);
WriteIO32(0xC001B004,temp);
printf("outputen register is 0x%x\r\n",temp);
...
while(1)
{
	temp|=(1<<12);
	delay(10000);
	WriteIO32(0xC001B000,temp);
	temp&=(~(1<<12));
	delay(10000);
	WriteIO32(0xC001B000,temp);
}

temp=ReadIO32(0xC001B000);
temp&=(~(1<<12));
WriteIO32(0xC001B000,temp);
printf("value register is 0x%x\n",temp);
